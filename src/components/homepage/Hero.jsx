...
<Carousel autoPlay className='min-h-[70vh] w-full' autoPlaySpeed={1500} showDots swipeable infinite removeArrowOnDeviceType={["tablet", "mobile","desktop", "superLargeDesktop"]} responsive={responsive}>
  ...
  <div>
    <img className="max-h-[70vh] min-w-full"  src="../../../assets/corosolImg/5.webp" alt="" />
  </div>
  <div>
    <img className="max-h-[70vh] min-w-full" src="../../../assets/corosolImg/6.webp" alt="" />
  </div>
  <div>
    <img className="max-h-[70vh] min-w-full" src="../../../assets/corosolImg/7.webp" alt="" />
  </div>
</Carousel>
